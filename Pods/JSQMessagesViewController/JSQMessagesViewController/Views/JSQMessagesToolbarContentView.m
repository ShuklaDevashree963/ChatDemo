...
@property (weak, nonatomic) IBOutlet UIView *attachmentButtonContainerView;
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *attachmentButtonContainerViewWidthConstraint;
...
- (void)setBackgroundColor:(UIColor *)backgroundColor
{
    ...
    self.attachmentButtonContainerView.backgroundColor = backgroundColor;
}
...
- (void)setAttachmentButtonItem:(UIButton *)attachmentButtonItem
{
    self.attachmentButtonContainerView.hidden = NO;
    [attachmentButtonItem setTranslatesAutoresizingMaskIntoConstraints:NO];
    
    [self.attachmentButtonContainerView addSubview:attachmentButtonItem];
    [self.attachmentButtonContainerView jsq_pinAllEdgesOfSubview:attachmentButtonItem];
    [self setNeedsUpdateConstraints];
    
    _attachmentButtonItem = attachmentButtonItem;
