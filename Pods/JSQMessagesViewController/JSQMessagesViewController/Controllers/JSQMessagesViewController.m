...
- (void)didPressAttachmentButton:(UIButton *)sender
{
    NSAssert(NO, @"Error! required method not implemented in subclass. Need to implement %s", __PRETTY_FUNCTION__);
}
...
- (UICollectionViewCell *)collectionView:(JSQMessagesCollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
   ...
   // cell.cellTopLabel.textInsets = UIEdgeInsetsMake(0.0f, bubbleTopLabelInset, 0.0f, 0.0f);
...
- (void)messagesInputToolbar:(JSQMessagesInputToolbar *)toolbar didPressAttachmentButton:(UIButton *)sender
{
    [self didPressAttachmentButton:sender];
}
